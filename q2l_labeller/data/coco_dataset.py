...
if __name__ == "__main__":
    ...
    train_set = CoCoDataset(
        image_dir=(data_dir + "image/val2017"),
        anno_path=(data_dir + "annotations/instances_val2017.json"),
        input_transform=train_transforms,
        labels_path=(data_dir + "annotations/labels_train2017.npy"),
            )