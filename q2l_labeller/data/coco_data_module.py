...
class COCODataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None) -> None:
        ...
        self.train_set = CoCoDataset(
            image_dir=(self.data_dir + "image/val2017"),
            anno_path=(self.data_dir + "annotations/instances_val2017.json"),
            input_transform=train_transforms,
            labels_path=(self.data_dir + "annotations/labels_train2017.npy"),
        )
        self.val_set = CoCoDataset(
            image_dir=(self.data_dir + "image/val2017"),
            anno_path=(self.data_dir + "annotations/instances_val2017.json"),
            input_transform=test_transforms,
            labels_path=(self.data_dir + "annotations/labels_val2017.npy"),
        )
        """
